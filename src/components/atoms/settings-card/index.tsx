...
const SettingsCard: React.FC<SettingsCardProps> = ({
  ...
  return (
    <Link to={`${to}`} className="flex items-center flex-1">
      ...
      >
        <div className="h-2xlarge w-2xlarge bg-toya-icon rounded-circle flex justify-center items-center toya-icon-color group-disabled:bg-grey-10 group-disabled:text-grey-40">
          {icon}
        </div>
