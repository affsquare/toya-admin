  ...
  return (
    <div className="h-72 border-b border-grey-20">
      ...
      <div
        ...
        className="flex items-center bg-grey-0 px-2.5 py-1.5 cursor-pointer toya-color"
      >
        <div className="w-[24px] h-[24px]  bg-toya-icon toya-icon-color rounded-full text-center flex justify-center items-center text-violet-60">
          <PlusIcon size={16} />
        </div>
